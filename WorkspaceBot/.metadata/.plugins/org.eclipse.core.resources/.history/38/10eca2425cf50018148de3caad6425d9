...
public class CallMatches {
	 ...
	 */
	public static void RegoleTechnicheWebServices(SianConnect sc, Update update) {
	 ...
	 * @param update
	 */
	public static void AllOtherMessages(SianConnect sc, Update update) {
		try {
	 ...
	 * @param update
	 */
	public static void UserRegistration(SianConnect sc, Update update) {
	 ...
	 * @param update
	 */
	public static void createInlineKeyboardLinks(SianConnect sc, Update update) {
		Long chat_id = update.getMessage().getChatId();
	...
	public static void createAbilitazione(SianConnect sc, Update update, Long idLink) {
